...
`($([$($inner:tt)*]),* $(,)*)` 表示重复匹配`[pattern],` ，其中有个概念叫尾部分割符详情可以查看[宏小册]([https://www.lhsz.xyz/read/DaseinPhaos-tlborm-chinese/pat-trailing-separators.md](https://www.lhsz.xyz/read/DaseinPhaos-tlborm-chinese/pat-trailing-separators.md))
